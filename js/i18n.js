(function () {
  const messages = {
    'en-us': {
      ...
      providerConfigurationMissing: '{provider} login is not configured for this environment.',
    ...
    'zh-cn': {
      ...
      providerConfigurationMissing: '{provider} 登录方式尚未配置。',
    ...
    'zh-hant': {
      ...
      providerConfigurationMissing: '{provider} 登入方式尚未設定。',
